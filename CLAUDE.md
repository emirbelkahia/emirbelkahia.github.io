...
- `build-site.py` — generates HTML, JSON-LD, `cv.md` and `llms.txt`; `--pdf` also builds the PDF
...
- Run `npm run check:build` and `npm test` before merging site changes; setup and prerequisites are in README.md.
